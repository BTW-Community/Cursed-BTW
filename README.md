...
If you want to run fabric mods with BTW in a non-dev environment, you have to use the BTW-fabric MultiMC instance which was 
shared on the [BTW Discord](https://discord.gg/fhMK5kx). 
