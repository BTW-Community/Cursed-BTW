...
If you want to run fabric mods with BTW in a non-dev environment, you have to use the BTW-fabric MultiMC instance which is available here: [MultiMC Instance Fabric + BTW](https://github.com/BTW-Community/cursed-fabric-loader/releases) 

Drop on by the discord channel if you need help: [BTW Discord](https://discord.gg/fhMK5kx). 

The mod file for release is generated by the gradle task *remapJar* and then put into `release`.
...
Java reflection might not work if they reference obfuscated names via Strings (as mentioned above), for example CraftGuide. 
